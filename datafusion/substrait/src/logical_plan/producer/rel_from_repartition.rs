...
use datafusion::common::{not_impl_err, substrait_err, DFSchemaRef};
use datafusion::logical_expr::{Expr, Partitioning, Repartition};
use substrait::proto::exchange_rel::{ExchangeKind, RoundRobin, ScatterFields};
use substrait::proto::expression::field_reference::{
    ReferenceType, RootReference, RootType,
};
use substrait::proto::expression::{reference_segment, FieldReference, ReferenceSegment};
